...
{% if event.type == "break" %}
<tr>
    <td style="border: 1pt 0pt 1pt 0pt solid black">{{ event.time }}</td>
    <td style="border: 1pt 0pt 1pt 0pt solid black">{{ event.title }}</td>
    <td style="border: 1pt 0pt 1pt 0pt solid black">{{ event.location}}</td>
</tr>
{% else %}
